...
<div id="bilan_carbone">
    <form method="post" action="<?php echo url_for('bilan_carbone/index') ?>">
        ...
        <fieldset>
            ...
            <div>
                <?php echo $form['train']->renderLabel(__('Distance parcourue en moyenne par mois en train')).' : '.$form['train']->render(array('value' => '0', 'size' => '6')).' '.__('km').$form['train']->renderError(); ?><br/>
                <?php echo $form['bus']->renderLabel(__('Temps passé en moyenne par semaine dans des transports en commun de proximité non propulsés à l\'électricité (ex.: bus)')).' : '.$form['bus']->render(array('value' => '0', 'size' => '6')).' '.__('minute(s)').$form['bus']->renderError(); ?><br/>
                <?php echo $form['metro']->renderLabel(__('Temps passé en moyenne par semaine dans des transports en commun de proximité propulsés à l\'électricité (ex.: métro)')).' : '.$form['metro']->render(array('value' => '0', 'size' => '6')).' '.__('minute(s)').$form['metro']->renderError(); ?><br/>
            </div>
        </fieldset>
        <fieldset>
