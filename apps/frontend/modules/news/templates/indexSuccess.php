...
<?php foreach($news as $new)
{
	...
	<p class="news_content"><?php echo $new->getFormatedText(config::getInstance()->get('char_by_news_list')); ?> <a class="news_link" href="<?php echo url_for('news_show', $new);?>"><?php echo __('Lire la suite'); ?></a></p>
