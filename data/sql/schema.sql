...
<<<<<<< HEAD
CREATE TABLE news (id BIGINT AUTO_INCREMENT, content text, is_activated TINYINT(1) DEFAULT '0' NOT NULL, language_id BIGINT, publication_date DATETIME, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX language_id_idx (language_id), PRIMARY KEY(id)) ENGINE = INNODB;
=======
