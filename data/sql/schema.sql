...
CREATE TABLE counter (id BIGINT AUTO_INCREMENT, initial_number BIGINT NOT NULL, initial_date DATETIME NOT NULL, flow FLOAT(18, 7) NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
