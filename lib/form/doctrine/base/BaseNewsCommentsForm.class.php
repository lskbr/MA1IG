...
/**
 * NewsComments form base class.
 *
 * @method NewsComments getObject() Returns the current form's model object
 *
 * @package    grainedevie
 * @subpackage form
 ...
 */
abstract class BaseNewsCommentsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('news_comments[%s]');
